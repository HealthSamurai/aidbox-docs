...
<figure><img src="../assets/image (4).png" alt="Import FHIR package dialog in Aidbox UI"><figcaption></figcaption></figure>

At this point, you should be able to see the loaded package in the packages list. 


<figure><img src="../assets/image (5).png" alt="Imported packages list in Aidbox UI"><figcaption></figcaption></figure>
