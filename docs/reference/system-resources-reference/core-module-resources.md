...
[ {
  ...
  "path" : "notificationEvent.correlationId",
  "name" : "correlationId",
  "lvl" : 1,
  "min" : 0,
  "max" : 1,
  "type" : "string",
  "desc" : "Opaque correlation id echoed from the triggering request."
}, {
  "path" : "status",
  "name" : "status",
  "lvl" : 0,
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:_elements",
  "lvl" : 0,
  "min" : 0,
  "max" : "*",
  "type" : "",
  "desc" : "Root element names to include in exported resources (experimental). Each entry is a comma-separated list of element names or a single element name."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
...
[ {
  ...
  "path" : "params.export-elements",
  "name" : "export-elements",
  "lvl" : 1,
  "min" : 0,
  "max" : "*",
  "type" : "string",
  "desc" : "Element names requested via _elements. One element name per entry (not comma-separated)."
}, {
  ...
  "path" : "params.storage.storage",
  "name" : "storage",
  "lvl" : 2,
  "min" : 0,
  "max" : 1,
  "type" : "string",
  "desc" : "Azure storage account name (for workload identity)."
}, {
  "path" : "params.storage.container",
  "name" : "container",
  "lvl" : 2,
  "min" : 0,
  "max" : 1,
  "type" : "string",
  "desc" : "Azure container name (for workload identity)."
}, {
...
Input parameters for the $configure-api operation.
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:dataOffloadToExternalStorage",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  ...
  "max" : 1,
  "type" : "Reference",
  "desc" : "\n\n**Allowed references**: AzureContainer"
}, {
  "path" : "parameter.part.resource",
  "name" : "resource",
  "lvl" : 2,
  ...
  "max" : 1,
  "type" : "Reference",
  "desc" : "\n\n**Allowed references**: GcpServiceAccount"
}, {
  "path" : "parameter.part.resource",
  "name" : "resource",
  "lvl" : 2,
...
Input parameters for the $configure-storage operation.
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:historyTableName",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  ...
  "path" : "parameter",
  "name" : "parameter:structureDefinition",
  "lvl" : 0,
  "min" : 1,
  "max" : 1,
  "type" : "",
...
Input parameters for the $create-api operation.
...
Input parameters for the $create-storage operation.
...
## CustomAWSSNSAtLeastOnceProfile

Custom AWS SNS at-least-once delivery profile with bundle enrichment support.
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:aidboxAuth",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  "desc" : "Aidbox basic auth credentials (username:password) for fetching referenced resources."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "path" : "parameter",
  "name" : "parameter:aidboxUrl",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  "desc" : "Aidbox base URL for fetching referenced resources during bundle enrichment."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
...
## CustomAWSSNSBestEffortProfile

Custom AWS SNS best-effort delivery profile with bundle enrichment support.
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:awsAccessKeyId",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  "desc" : "AWS access key ID (omit to use default provider chain: env / EC2 / EKS IRSA). Supports vault refs."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "max" : 1,
  "type" : "",
  "desc" : "AWS region for the S3 bucket (required for real AWS; MinIO/Garage accept us-east-1)"
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "path" : "parameter",
  "name" : "parameter:awsSecretAccessKey",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  "desc" : "AWS secret access key. Pair with awsAccessKeyId. Supports vault refs."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "max" : 1,
  "type" : "",
  "desc" : "Number of messages per Delta commit batch"
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "max" : 1,
  "type" : "",
  "desc" : "Custom S3 endpoint (MinIO / Garage / LocalStack). Forces path-style URLs."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "max" : 1,
  "type" : "",
  "desc" : "Maximum time between commits in milliseconds"
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
  ...
  "path" : "parameter",
  "name" : "parameter:targetFileSizeMb",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
  "desc" : "Target Parquet file size in MiB during initial export (default 128). Avoid tiny files."
}, {
  "path" : "parameter.name",
  "name" : "name",
  "lvl" : 1,
...
Input parameters for the $delete-api operation.
...
Input parameters for the $delete-storage operation.
...
[ {
  ...
  "path" : "parameter",
  "name" : "parameter:keyByResourceId",
  "lvl" : 0,
  "min" : 0,
  "max" : 1,
  "type" : "",
...
[ {
  ...
  "max" : 1,
  "type" : "string",
  "desc" : "Type of cell content. \n\n**Allowed values**: `rpc` | `rest` | `empty` | `markdown` | `sql` | `view-definition` | `sql-query` | `sql-view`"
}, {
  "path" : "cells.nb-title",
  "name" : "nb-title",
  "lvl" : 1,
...
[ {
  ...
  "max" : "*",
  "type" : "code",
  "desc" : "Custom scopes that authorize access to this operation."
}, {
  "path" : "transform",
  "name" : "transform",
  "lvl" : 0,
...
[ {
  ...
  "max" : 1,
  "type" : "",
  "desc" : "depends-on for ViewDefinition or SQLView references"
}, {
  ...
  "max" : 1,
  "type" : "canonical",
  "desc" : "Canonical URL of a ViewDefinition or SQLView"
}, {
  "path" : "type",
  "name" : "type",
  "lvl" : 0,
...
[ {
  ...
  "max" : 1,
  "type" : "",
  "desc" : "Not permitted (views cannot be parameterised)"
}, {
  "path" : "relatedArtifact",
  "name" : "relatedArtifact",
  "lvl" : 0,
  ...
  "max" : 1,
  "type" : "",
  "desc" : "Table name used in SQL view"
}, {
  "path" : "relatedArtifact.resource",
  "name" : "resource",
  "lvl" : 1,
