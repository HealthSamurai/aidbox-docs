...
![REST Console UI](../../../assets/ui-rest-console.avif)
...
![REST Console showing pretty-formatted response output](../../../assets/9509a2a9-23ef-417c-98d7-340282df4e01.avif)
...
![GET /Patient](../../../assets/rest-console-get-patient.avif)
