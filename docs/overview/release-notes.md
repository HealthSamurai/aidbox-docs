...
*   Aidbox FHIR server
    ...
    * **[Binary resource content-type support](../api/rest-api/other/binary.md)** — the `/fhir/Binary` endpoints follow the FHIR rules for handling Binary over REST. `POST` and `PUT` accept raw bodies of any content type and build the resource from the `Content-Type` header and the body bytes, and `GET` returns the decoded content when `Accept` matches `Binary.contentType`, or the FHIR JSON resource for JSON accept types.
...
*   Aidbox FHIR server
    ...
    * Fixed [OrgBac](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md) operation definitions.
...
* Aidbox FHIR server
  ...
  * Organization-based hierarchical access control improvements:
    * Added a tenant-aware [login API](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#authentication) for organization-based hierarchical access control.
    * Tenant-aware [group-level export](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#group-level-export) is now supported.
...
* Aidbox FHIR server
  ...
  * Audit events generated by Aidbox are now [Organization-based hierarchical access control](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md) aware.
...
* Security and access control
  ...
  * Supported history endpoint within [the Organisation-based access control](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#history)
...
* Security and access control
  * Supported [Bundle batch operation in Multitenant API](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#bundle)
...
* Security and access control
  * Added [Capability Statement ](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#metadata)endpoint for multitenant API
  * Added [bundle transaction](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#bundle) for multitenant API
...
* Security and access control
  * Added [shared resources](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md#shared-resource-mode) in the [Organisation-based access control](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md)
...
* Security and access control
  * Added [hierarchical organization-based access control](../access-control/authorization/scoped-api/organization-based-hierarchical-access-control/README.md) (multi-tenancy on organization-level resources)
...
![Aidbox notebooks](../../assets/2021-09-03_16-53-32.avif)
