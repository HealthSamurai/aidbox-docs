...
* [fuzzystrmatch](https://www.postgresql.org/docs/current/fuzzystrmatch.html) — String similarities functions. Used by the [MDM module](https://www.health-samurai.io/docs/mdmbox) only.
