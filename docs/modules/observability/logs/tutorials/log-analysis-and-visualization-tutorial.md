...
![Kibana field selection interface for log attributes](../../../assets/5027d2cd-2a95-4b43-9201-33d0cc38fbef.png)

Now you can browse and explore REST API logs

![Kibana Discover view showing REST API logs](../../../assets/d729a589-5d2a-4e95-82c5-e3bbfa80f3d0.png)
